...
INSERT INTO "new_File" ("created_at", "device_id", "disc_number", "episode_info_id", "file_hash", "file_path", "file_size", "folder_type", "id", "inode", "is_directory", "is_multi_disc", "is_parent_folder", "is_special_folder", "link_path", "mediaId", "parent_folder_id") SELECT "created_at", "device_id", "disc_number", "episode_info_id", "file_hash", "file_path", "file_size", "folder_type", "id", "inode", "is_directory", "is_multi_disc", "is_parent_folder", "is_special_folder", "link_path", "mediaId", "parent_folder_id" FROM "File";
DROP TABLE "File";
